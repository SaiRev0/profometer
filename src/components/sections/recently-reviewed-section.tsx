    ...
    <section className='mt-6'>
      <div className='mb-4 flex items-center justify-between'>
        ...
        <div className='flex gap-2'>
          <Button variant='outline' size='icon' onClick={() => scrollRecentSection('left')} className='hidden md:flex'>
            <ChevronRight className='h-4 w-4 rotate-180' />
          </Button>
          <Button variant='outline' size='icon' onClick={() => scrollRecentSection('right')} className='hidden md:flex'>
